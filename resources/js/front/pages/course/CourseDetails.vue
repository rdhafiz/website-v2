                ...
                <div class="row">
                    <div class="col-lg-7">
                        ...
                        <div class="course-details-description">
                            <div>
                                3 Courses starting Spring 2025
                            </div>
                            <br>
                            <ul>
                                <li>
                                ...
                                <li>
                                    Saturday: 9.30am – 4pm from the 29th March to the 10th of January 2026
                                </li>
                            </ul>
                        </div>
                        <br>
                    ...
                    <div class="col-lg-7">
                        ...
                        <br>
                        <div class="course-details-description">
                            Your nursing career will mean working with adults of all ages.
                            They may suffer from one or more long or short-term physical health
                            conditions. This could include heart disease, injuries from an
                            accident, pneumonia, arthritis, diabetes or cancer.
                            <br>
                            You could work in a variety of settings, including hospital
                            wards, outpatient units, patients' homes and clinics. You'll be part
                            of the multidisciplinary teams with other professionals such as occupational
                            therapists, pharmacists, radiographers and healthcare assistants.
                            You'll also work closely with patients' families and careers.
                        </div>
                        <br>
                        <div class="course-details-title fw-semibold">
