        ...
        <div class="w-100 px-0 px-md-5">
            <div class="w-100 px-2 px-md-5">
                <div class="container-fluid py-5">
                    ...
                    <router-link :to="{name: 'ApplyForInterest', params: {course: 'access-to-he-health-professions'}}" class="btn px-3 py-2 btn-theme me-2">Learn More</router-link>
                    <router-link :to="{name: 'ApplyForInterest', params: {course: 'access-to-he-health-professions'}}" class="btn px-3 py-2 btn-theme">Apply Now</router-link>
                </div>
            </div>
        </div>
    </section>
