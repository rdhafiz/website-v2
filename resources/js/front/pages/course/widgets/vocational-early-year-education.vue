        ...
        <div class="w-100 px-0 px-md-5">
            <div class="w-100 px-2 px-md-5">
                <div class="container-fluid py-5">
                    ...
                    <router-link :to="{name: 'ApplyForInterest', params: {course: 'early-years-educator'}}" class="btn px-3 py-2 btn-theme me-2">Learn More</router-link>
                    <router-link :to="{name: 'ApplyForInterest', params: {course: 'early-years-educator'}}" class="btn px-3 py-2 btn-theme">Apply Now</router-link>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="w-100 mt-5">
                                ...
                                <h5 class="text-secondary fw-normal">
                                    Work experience is an essential part of the course. You will need to attend 400
                                    hours over the period of the course either employed or as a volunteer in a childcare
                                    setting.
                                </h5>
                            </div>
                            ...
                            <div class="w-100 mt-5">
                                ...
                                <h5 class="text-secondary fw-normal">
                                    All sessions are taught by experienced trainers who are subject specialists.
                                    This full level 3 qualification is the license to practice, and it enables you to join the workforce as an Early Years Educator.
                                    ...
                                    <ul>
                                        ...
                                        <li>safeguarding and child welfare</li>
